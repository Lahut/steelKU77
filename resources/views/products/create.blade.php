    ...
    <div class="col-5">
        ...
        <div class="input-group" style="width:88%;">
            ...
            <div class="custom-file">
                <input type="file" name="img" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" onchange="readURL(this);">
                <label class="custom-file-label" for="inputGroupFile01">เลือกรูปสินค้า</label>
            </div>
        </div>
    </div>
    <form name="form1" method="POST" action="{{ route('products.store') }}" style="width:100%;"><br><br>
        <div class="col-7">
            @csrf
            <h6>ชื่อสินค้า</h6>
